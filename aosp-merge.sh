...
WORKING_DIR=/home/build-folder-here

# The tag you want to merge in goes here
BRANCH=android-7.0.0_r19
...
blacklist=('manifest' 'prebuilt' 'prebuilts' 'packages/apps/DeskClock' 'external/google' 'external/nano' 'external/openssh' 'external/stlport' 'packages/apps/Browser' 'packages/apps/FMRadio' 'prebuilts/gcc/darwin-x86/arm/arm-eabi-4.8' 'prebuilts/gcc/linux-x86/arm/arm-eabi-4.8')
